      ...
      <section id="services" className="services">
        <div className="services__bg-top">
          <div className="wrapper">
            <div>
              <img className="icon__slash"  src="./src/assets/images/svg/slash-line--white.svg" alt="slash line" />
                  ...
                  <ul className="services__tags">
                    {card.tags.split(",").map((tag) => (
                      <li className="services__desc services__desc--margin" key={tag}>
                        <img className="services__svg" src="./src/assets/images/svg/romb.svg" alt="romb" />
                        {tag}
                      </li>
                    ))}
                  </ul>
